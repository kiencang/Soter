...
Thì có thể do trình duyệt đang quản lý hoặc hạn chế dùng GPU cho mục đích mô phỏng. Cách đơn giản nhất là tắt các tab trình duyệt khác, và tải lại trang web của ứng dụng.
